    ...
    if Application.get_env(:budget, :environment, %{}) |> Map.get(:name) == :dev do
      ...
      [
        ...
        %{
          ...
          originator: "regular",
          regular: %{description: "Bar", category_id: c_lazer.id},
        ...
        %{
          date: Timex.shift(month_first, days: 11),
          originator: "regular",
          regular: %{description: "Mercado", category_id: c_mercado.id},
          account_id: acc_nu.id,
          value: -130
        },
        %{
          date: Timex.shift(month_first, days: 14),
          originator: "regular",
          regular: %{description: "Mercado", category_id: c_mercado.id},
          account_id: acc_nu.id,
          value: -102
        ...
        %{
          date: Timex.shift(month_first, days: 15),
          originator: "regular",
          regular: %{description: "Combustível", category_id: c_transporte.id},
          account_id: acc_nu.id,
          value: -220
        },
        %{
          date: Timex.shift(month_first, days: 15),
          originator: "regular",
          regular: %{description: "Calça", category_id: c_vestuario.id},
          account_id: acc_nu.id,
          value: -100
        },
        %{
          date: Timex.shift(month_first, days: 16),
          originator: "regular",
        ...
        %{
          ...
          originator: "regular",
          regular: %{description: "Combustível", category_id: c_viagem.id},
          account_id: acc_nu.id,
          value: -200
        },
        %{
          date: Timex.shift(month_first, days: 22),
          originator: "regular",
          regular: %{description: "Restaurante", category_id: c_viagem.id},
          account_id: acc_nu.id,
          value: -55
        },
        %{
          date: Timex.shift(month_first, days: 24),
          originator: "regular",
          regular: %{description: "Alergologista", category_id: c_consultas.id},
          account_id: acc_bb.id,
          value: -200
        },
        %{
          date: Timex.shift(month_first, days: 24),
          originator: "regular",
          regular: %{description: "Remédios", category_id: c_farmacia.id},
          account_id: acc_bb.id,
          value: -230
        },
        %{
          date: Timex.shift(month_first, days: 5, months: 1),
          originator: "transfer",
          transfer: %{other_account_id: acc_nu.id},
          account_id: acc_bb.id,
          value: -1086
        }
      ]
